...
.PHONY: all test run demo clean test_nested_smoke test_nested_smoke_ci win_hal_check win_step60a_check test_win64_abi win_step60b_check test_win64_hal_core win_step61_check arm64_hal_check arm64_step63_check test_arm64_hal test_arm64_canvas test_arm64_codegen aura_shell_win
...
win_step61_check: $(WIN_BOOTSTRAP_OBJ) $(WIN_SYSCALL_OBJ) $(WIN_MEMORY_OBJ) $(WIN_TIME_OBJ) $(WIN_THREADS_OBJ) $(WIN_ABI_OBJ) $(WIN_WINDOW_OBJ) $(WIN_GDI_OBJ) $(WIN_EXECUTOR_WIN_OBJ) $(TEST_WIN32_HAL_OBJ) $(TEST_WIN32_WINDOW_OBJ)
